...
# Shareholders/staff are auto-logged-out after this many seconds of
# inactivity (see apps.core.middleware.IdleSessionTimeoutMiddleware).
# Customer/captive-portal sessions are unaffected.
SHAREHOLDER_IDLE_TIMEOUT_SECONDS = 3600
